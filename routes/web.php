...
Route::group(['middleware' => ['auth', 'admin'], 'prefix' => 'admin'], function () {
    ...
    Route::put('/product/set-promotion-for-all', [ProductController::class, 'setPromotionForAll'])->name('admin.product.setPromotionForAll');
    ...
    Route::put('/order/{order}/confirm-payment', [OrderController::class, 'confirmPayment'])->name('admin.order.confirmPayment');
    ...
    Route::put('/ticket/set-promotion-for-all', [TicketController::class, 'setPromotionForAll'])->name('admin.ticket.setPromotionForAll');
    ...
    Route::get('/notification/details/{groupId}', [NotificationController::class, 'showGroupDetails'])->name('admin.notification.showGroupDetails');
});
