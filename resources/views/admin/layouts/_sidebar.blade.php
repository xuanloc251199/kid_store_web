<div class="navigation">
  <ul>
    ...
    <li class="{{ in_array(Route::currentRouteName(), ['admin.notification.index', 'admin.notification.create', 'admin.notification.update']) ? 'hovered active' : '' }}">
      <a href="{{route('admin.notification.index')}}">
        <span class="icon"><ion-icon name="notifications-outline"></ion-icon></span>
        <span class="title">Notifications</span>
      </a>
    </li>
    <li class="{{ in_array(Route::currentRouteName(), ['admin.order.index', 'admin.order.create', 'admin.order.update']) ? 'hovered active' : '' }}">
