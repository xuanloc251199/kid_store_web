            ...
            <div class="formbold-form-wrapper">
                <form action="{{ route('admin.product.store') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="formbold-mb-5">
                        ...
                        <input type="file" name="thumbnail" id="photo" accept="image/*"
                            class="formbold-form-input" />
                    </div>
                    <div class="formbold-mb-5">
                        <label for="price" class="formbold-form-label"> Price </label>
                        <input type="number" name="price" id="name" placeholder="Price"
                            class="formbold-form-input" />
                    </div>
                    <div class="formbold-mb-5">
                        ...
                        <input type="number" name="promotion" id="promotion" placeholder="Enter discount percentage"
                            class="formbold-form-input" min="0" max="100"
                            value="{{ old('promotion', $product->promotion ?? 0) }}" />
                    </div>
                    <div class="formbold-mb-5">
                        <label for="quantity" class="formbold-form-label"> Quantity </label>
                        <input type="number" name="quantity" id="name" placeholder="Quantity"
                            class="formbold-form-input" />
                    </div>
                    <div class="formbold-mb-5">
                        <label for="detail" class="formbold-form-label"> Detail </label>
                        <textarea rows="6" name="detail" id="FormControlTextarea1" placeholder="Type your Detail"
                            class="formbold-form-input"></textarea>
                    </div>
                    <div class="formbold-mb-5">
                        <label for="description" class="formbold-form-label"> Description </label>
                        <textarea rows="6" name="description" id="FormControlTextarea2" placeholder="Type your description"
                            class="formbold-form-input"></textarea>
                    </div>
