    ...
    <div class="formbold-form-wrapper">
      <form action="{{route('admin.ticket.store')}}" method="POST" enctype="multipart/form-data">
        ...
        <div class="formbold-mb-5">
          ...
          <textarea rows="6" name="detail" id="FormControlTextarea1" class="formbold-form-input"></textarea>
        </div>
        <div class="formbold-mb-5">
          <label for="description" class="formbold-form-label"> Description </label>
          <textarea rows="6" name="description" id="FormControlTextarea2" class="formbold-form-input"></textarea>
        </div>
