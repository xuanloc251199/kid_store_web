    ...
    <div class="formbold-form-wrapper">
      <form action="{{route('admin.ticket.update',$ticket->id)}}" method="POST" enctype="multipart/form-data">
        ...
        <div class="formbold-mb-5">
          ...
          <input type="file" name="thumbnail"  value="{{$ticket->thumbnail}}" id="image" accept="image/*" class="formbold-form-input" />
        ...
        <div class="formbold-mb-5">
          <label for="number_ticket" class="formbold-form-label"> Sold </label>
          <input type="number" name="number_ticket" id="number_ticket" value="{{$ticket->sold}}" class="formbold-form-input" />
        </div>
        <div class="formbold-mb-5">
        ...
        <div class="formbold-mb-5">
          ...
          <textarea rows="6 name="detail" id="FormControlTextarea1" class="formbold-form-input">{{$ticket->detail}}</textarea >
        </div>
        <div class="formbold-mb-5">
          <label for="description" class="formbold-form-label"> Description </label>
          <textarea rows="6 name="description" id="FormControlTextarea2" class="formbold-form-input">{{$ticket->description}}</textarea >
        </div>
